...
.button {
  ...
  cursor: pointer;
  	...
  	<title>Client registration status</title>
    <meta charset="utf-8">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section" style="font-family:normal;">CLIENT REGISTER</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
				<h6 class="h5 mb-4 text-center"><a  href="webappreq.html" class="button" style="font-family:normal;">HOME</a></h6>
