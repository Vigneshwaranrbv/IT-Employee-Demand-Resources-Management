		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section" style="font-family:normal;">CLIENT QUERY</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
				<h6 class="h5 mb-4 text-center"><a  href="tthomepg.html" class="button" style="font-family:normal;">HOME</a></h6>
					<div class="table-wrap" style="height:400px;overflow:auto;">
						<table class="table">
						  ...
						  ResultSet rs1=null;
						  try{
							  String qry2 = "Select * from clientquery"; 
