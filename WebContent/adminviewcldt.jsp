		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section" style="font-family:normal;">CLIENT APPROVAL</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
						...
						<table class="table">
						  ...
						  <tbody>
						    <tr>
						      ...
						      <button class="button1"  value="approved" name="status" style='background-color:green;font-family:normal;'>ACCEPT</button>
						      <button class="button1"  value="rejected" name="status" style='background-color:red;font-family:normal;'>REJECT</button> 
